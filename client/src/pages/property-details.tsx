...
const PropertyDetails = () => {
  ...
  return (
    ...
    >
      ...
      <Box
        mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4}
      >
        <Box flex={1} maxWidth={764}>
          ...
          <Box mt="15px">
            ...
            <Stack direction="row" justifyContent="space-between" flexWrap="wrap" alignItems="center">
              ...
              <Box>
                <Typography fontSize={16} fontWeight={600} color="#11142d" mt="10px">Price</Typography>
                <Stack
                  direction='row'
                  alignItems='flex-end'
                  gap={1}
            ...
            <Stack mt="25px" direction='column' gap="10px">
              ...
              <Typography fontSize={14} color="#11142D">{propertyDetails.description}</Typography>
            </Stack>
          </Box>
        </Box>
        <Box

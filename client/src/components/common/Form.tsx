        ...
        >
          ...
          <FormControl>
            ...
            <TextareaAutosize
              ...
              color='info'
              style={{ width: "100%", background: 'transperent', fontSize: '16px', borderColor: 'rgba(0,0,0,0.23)', borderRadius: 6, padding: 10, color: '#919191' }}
            ...
            <Stack direction='row' gap={2}>
              ...
              <Button component='label' sx={{width:'fit-content' , color: '#2ed480', textTransform:'capitalize', fontSize: 16}}>
                ...
                <input 
                  ...
                  type='file'
                  onChange={(e) =>{
                    //@ts-ignore the following comment ignores the below warning in handleImageChange
